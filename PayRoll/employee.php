...
echo "<td><a href='empdel.php?emp_id=$row[emp_id]'>Delete</td>";
...
?>
 ...
 <a href="employee.php" class="previous">&laquo; BACK</a>  
 <button class="bt">  <a href="empins.html" style="color:black"> INSERT </a> </button>
 </div>
 </div>