...
echo "<td><a href='salarydel.php?emp_id=$row[emp_id]'>Delete</td>";
...
?>
 ...
 <a href="salary.php" class="previous">&laquo; BACK</a>  
 <button class="bt">  <a href="salaryins.html" style="color:black"> INSERT </a> </button>
 </div>
 </div>